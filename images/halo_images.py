...
make_image(mass, "inferno", "masses")
make_image(diff, cm.ice, "diff", 0.01, 1.0)
make_image(visc, cm.curl, "visc", 0.2, 2.0)
make_image(temp, "twilight", "temp", 1e2, 1e8)
make_image(mmf, "cubehelix", "mmf", 0.0012, 1.2)
